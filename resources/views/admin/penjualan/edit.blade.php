...
@section('container')
    <section>
        ...
        {{-- isi --}}
        <div class="pt-24">
            <form action="{{ route('penjualan.update', ['id' => $data->id]) }}" method="POST" class="max-w-[800px] mx-auto">
                @csrf
                <div>
                ...
                <div class="mt-3">
                    ...
                    <div class="relative ">
                        ...
                        peer
                    @enderror"
                            placeholder="Pilih Tanggal" value="{{ $data->tgl_berangkat }}" autocomplete="off">
                ...
                <div class="mt-3">
                    ...
                    <div class="relative ">
                        ...
                        peer
                    @enderror"
                            placeholder="Pilih Tanggal" value="{{ $data->tgl_sampai }}" autocomplete="off">
                    </div>
                    @error('tgl_sampai')
                        <p class="peer-invalid:visible text-red-700 font-light">
                            {{ $message }}
                ...
                <div class="mt-3">
                    ...
                    <div class="relative ">
                        ...
                        peer
                    @enderror"
                            placeholder="Pilih Tanggal" value="{{ $data->tgl_pemesanan }}" autocomplete="off">
                    </div>
                    @error('tgl_pemesanan')
                        <p class="peer-invalid:visible text-red-700 font-light">
                            {{ $message }}
                ...
                <div class="mt-3">
                    ...
                    <select name="status_pembayaran" id="status_pembayaran"
                        ...
                        <option value="sudah bayar" {{ $data->status_pembayaran == 'sudah bayar' ? 'selected' : '' }}>
                            Sudah Dibayar</option>
                        <option value="belum dibayar" {{ $data->status_pembayaran == 'belum dibayar' ? 'selected' : '' }}>
                ...
                <div class="mt-3">
                    ...
                    <select name="jenis_pembayaran" id="jenis_pembayaran"
                        ...
                        <option value="transfer" {{ $data->jenis_pembayaran == 'transfer' ? 'selected' : '' }}>Transfer
                        </option>
                        <option value="cash" {{ $data->jenis_pembayaran == 'cash' ? 'selected' : '' }}>Cash</option>
                    </select>
